...
internal sealed class HammerContext : DbContext
{
    ...
    public DbSet<AltAccount> AltAccounts
    {
        get => Set<AltAccount>();
    }
    ...
    public DbSet<BlockedReporter> BlockedReporters
    {
        get => Set<BlockedReporter>();
    }
    ...
    public DbSet<Infraction> Infractions
    {
        get => Set<Infraction>();
    }
    ...
    public DbSet<MemberNote> MemberNotes
    {
        get => Set<MemberNote>();
    }
    ...
    public DbSet<ReportedMessage> ReportedMessages
    {
        get => Set<ReportedMessage>();
    }
    ...
    public DbSet<StaffMessage> StaffMessages
    {
        get => Set<StaffMessage>();
    }
    ...
    public DbSet<TemporaryBan> TemporaryBans
    {
        get => Set<TemporaryBan>();
    }
    ...
    public DbSet<TrackedMessage> TrackedMessages
    {
        get => Set<TrackedMessage>();
    }
