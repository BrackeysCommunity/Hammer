...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="Data.Infraction" /> class.
    /// </summary>
    public Infraction()
    {
    }
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="Data.Infraction" /> class by copying the values from another instance.
    /// </summary>
    ...
    /// <summary>
    ///     Determines whether two <see cref="Data.Infraction" /> instances are equal.
    /// </summary>
    ...
    /// <summary>
    ///     Determines whether two <see cref="Data.Infraction" /> instances are not equal.
    /// </summary>
    /// <param name="left">The first infraction.</param>
    /// <param name="right">The second infraction.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Determines whether one <see cref="Data.Infraction" /> was created before another <see cref="Data.Infraction" />.
    /// </summary>
    /// <param name="left">The first infraction.</param>
    /// <param name="right">The second infraction.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Determines whether one <see cref="Data.Infraction" /> was created after another <see cref="Data.Infraction" />.
    /// </summary>
    /// <param name="left">The first infraction.</param>
    /// <param name="right">The second infraction.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Determines whether one <see cref="Data.Infraction" /> was created at the same time as - or before - another
    ///     <see cref="Data.Infraction" />.
    /// </summary>
    /// <param name="left">The first infraction.</param>
    /// <param name="right">The second infraction.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Determines whether one <see cref="Data.Infraction" /> was created at the same time as - or after - another
    ///     <see cref="Data.Infraction" />.
    /// </summary>
    /// <param name="left">The first infraction.</param>
    /// <param name="right">The second infraction.</param>
    ...
    ///     </list>
    /// </returns>
    /// <exception cref="ArgumentException"><paramref name="obj" /> is not of type <see cref="Data.Infraction" />.</exception>
    ...
    /// <summary>
    ///     Returns a value indicating whether this <see cref="Data.Infraction" /> is equal to another <see cref="Data.Infraction" />.
    /// </summary>
