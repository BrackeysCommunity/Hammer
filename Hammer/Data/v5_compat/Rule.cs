...
internal sealed class Rule : IEquatable<Rule>
{
    ...
    /// <summary>
    ///     Determines whether two <see cref="Data.Rule" /> instances are equal.
    /// </summary>
    ...
    /// <summary>
    ///     Determines whether two <see cref="Data.Rule" /> instances are not equal.
    /// </summary>
    /// <param name="left">The first rule.</param>
    /// <param name="right">The second rule.</param>
    /// <returns>
    ...
    /// <summary>
    ///     Returns a value indicating whether this <see cref="Data.Rule" /> is equal to another <see cref="Data.Rule" />.
    /// </summary>
